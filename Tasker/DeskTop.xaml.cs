...
namespace Tasker
{
    ...
    /// </summary>
    public partial class DeskTop : ModernWindow
    {
        public DeskTop()
        {
            InitializeComponent();
        ...
        private void ModernWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            string sTheme = Properties.Settings.Default.uTheme;
            string sColor = Properties.Settings.Default.uAccentColor;
            Color myColor =Colors.DodgerBlue;
            var oConverter = new ColorConverter();
            var convertFromString = ((TypeConverter) oConverter).ConvertFromString(sColor);
            if (convertFromString != null)
            {
                 myColor = (Color)convertFromString;
            }

            AppearanceManager.Current.ThemeSource = sTheme.Contains("Dark") ? AppearanceManager.DarkThemeSource : new Uri("/Tasker;component/Resources/Themes/ModernUI.TaskerLight.xaml", UriKind.Relative);

            AppearanceManager.Current.FontSize = FirstFloor.ModernUI.Presentation.FontSize.Small;
            AppearanceManager.Current.AccentColor = myColor;
        }
