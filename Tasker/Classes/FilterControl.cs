...
namespace Tasker.Classes
{
    ...
    [TemplatePart(Name = PART_HeaderComboBox, Type = typeof(ComboBox))]
    ...
    public class FilterControl : Control
    {
        ...
        #region Declarations
        //TODO:Implementar ComboBox de Busquedas
        private const string PART_HeaderComboBox = "PART_HeaderComboBox";
        ...
        public FilterControl()
        {
            ...
            ListTextBindingPath = new List<FilterAdapter>();
        }
        ...
        #region ListTextBindingPath property

        public List<FilterAdapter> ListTextBindingPath
        {
            get
            {
                return (List<FilterAdapter>)GetValue(ListTextBindingPathProperty);
            }
            set
            {
                SetValue(ListTextBindingPathProperty, value);
            }
        }

        public static readonly DependencyProperty ListTextBindingPathProperty =
            DependencyProperty.Register("ListTextBindingPath", typeof(List<FilterAdapter>),
            typeof(FilterControl), new PropertyMetadata(null));

        #endregion

        #region AllPropertiesSearch property

        public bool AllPropertiesSearch
        {
            get
            {
                return (bool)GetValue(AllPropertiesSearchProperty);
            }
            set
            {
                SetValue(AllPropertiesSearchProperty, value);
            }
        }

        public static readonly DependencyProperty AllPropertiesSearchProperty =
            DependencyProperty.Register("AllPropertiesSearch", typeof(bool),
            typeof(FilterControl), new PropertyMetadata(false));
        ...
        public Type UnderlyingType
        {
            get
            {
                return (Type)GetValue(UnderlyingTypeProperty);
            }
            set
            {
                SetValue(UnderlyingTypeProperty, value);
            }
        }

        public static readonly DependencyProperty UnderlyingTypeProperty =
            DependencyProperty.Register("UnderlyingType", typeof(Type),
            typeof(FilterControl), new PropertyMetadata(null));
        ...
        private T GetDataValue<T>(object data, string propertyName)
        {
            ...
            var descriptorObjectValue = descriptor.GetValue(data) ?? "";
            var value = (T)descriptorObjectValue;
        ...
        private void AttachToVisualTree()
        {
            ...
            // Getting the ComboBox instance
            comboBox = GetTemplateChild(PART_HeaderComboBox) as ComboBox;
            if (comboBox != null)
            {
