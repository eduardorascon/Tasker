...
namespace Tasker.ViewModel
{
    ...
    /// </summary>
    public class CategoriesWorkSpaceViewModel
        : ViewModelBase
    {

        private readonly IDataService _dataService;
        public CategoriesWorkSpaceViewModel(IDataService dataService)
        {
        ...
        void DelegarComandos()
        {
            ...
            Messenger.Default.Register<string>(this, "CATEGORY_EDIT_MODE", (string msg) =>
                                                                           {
