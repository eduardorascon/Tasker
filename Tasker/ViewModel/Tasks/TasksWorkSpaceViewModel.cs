...
namespace Tasker.ViewModel
{
    ...
    /// </summary>
    public class TasksWorkSpaceViewModel
        : ViewModelBase
    {

        private readonly IDataService _dataService;
        public TasksWorkSpaceViewModel(IDataService dataService)
        {
        ...
        void DelegarComandos()
        {
            ...
            RefreshCommand = new RelayCommand(() => Messenger.Default.Send("Close", "PRESS_KEY_TASK"));
